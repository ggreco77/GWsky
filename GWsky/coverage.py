...
class ShowSkyCoverage(Airmass):
    ...
    def probability_inside_fov(self, infile, ra_vertices, dec_vertices):
         ...
         probability_inside_polygon = self.prob[ipix_poly].sum() # probability contains
                                                        #--> in a specific FOV
    ...
    def east(self, shift=0.00001):
        ...
        ra_distance = self._ra0ra1_distance((self.fov_width + shift),
                                            self.input_dec, self.input_dec)      

        east_pointing = [(self.input_ra + ra_distance), (self.input_dec)]      
    ...
    def west(self, shift=0.00001):
        ...
        west_pointing = [(self.input_ra - ra_distance), (self.input_dec)]     
    ...
    def plot_stats(self, time_step, airmass_values, ra, dec,
        ...
        def subplot_cat_distance():
            ...
            try:
                ...
                print ('No Galaxy in the selcted FoV')#, unbound_local_error
                
            finally:
                pass
            
        subplot_cat_distance = subplot_cat_distance()

        
        def subplot_cat_Bmag():
            """SubPlot apparent B magnitude."""
        ...
        subplot_cat_Bmag = subplot_cat_Bmag()                                      
