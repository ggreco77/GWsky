...
class UserInput(object):
    ...
    def display_welcome(self):
        ...
        #print (' The configuration file are read by the module *coverage*. ')
        #print('')
    ...
    def display_healpix_skymap(self):
        ...
        valid_healpix_skymap = False
        while not valid_healpix_skymap :
            try:
    ...
    def select_option(self):
        """(1) Load a valid contour-line file otherwise any key to skip."""

        valid_select_option = False
        while not valid_select_option:
            try:
                print ('--> Type (1) to load a valid contour-line file otherwise any key to skip. ')
                select = raw_input( ' : ' ).strip( )
                print ('')

                if select == "1":
                    self.probability_contours()
                else:
                    break
    ...
    def probability_contours(self):
        ...
        while not valid_probability_contours:
            try:
                ...
                valid_probability_contours = True
    ...
    def _fov_circle(self):
        ...
        valid_fov_circle = False
        while not valid_fov_circle:
            try:
                print(' ')
    ...
    def telescope_site(self):
        ...
        valid_telescope_site = False
        while not valid_telescope_site:
            try:
    ...
    def starting_time(self):
        ...
        valid_starting_time = False
        while not valid_starting_time:
            try:
    ...
    def GWsky_basic(self):
        ...
        valid_gwsky_basic = False
        while not valid_gwsky_basic:
            try:
    ...
    def display_note(self):
        ...
        print('')
        print(' You can change the default catalog at the line 330 in **coverage** module ')
        print (' e.g from GLADE to GWGC --> "VII/275/glade1" --> "VII/267" ')
        print('')
        print (' You can also change the catalog statistics ')
        print (' LINE 810: query_catalog.hist(table_pandas.Dist.dropna() --> ')
        print (' query_catalog.hist(table_pandas.**ColumnName**.dropna() ')
        print ('')
        print(' LINE 815: query_catalog.hist(table_pandas.Bmag.dropna()) --> ')
        print (' query_catalog.hist(table_pandas.**ColumnName**.dropna()) ')
        print(' ')
